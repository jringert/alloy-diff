...
one sig emailID extends string{}
...
one sig principalID extends string{}
...
one sig entryActionID extends string{}
...
one sig actionID extends string{}
...
one sig transitionID extends string{}
one sig fromStateID extends Integer{}
one sig toStateID extends string{}
...
one sig processStateMachineID extends string{}
...
one sig processQueryResponseActionID extends string{}
