...
abstract one sig SecEmailChannel extends Class{}{
attrSet = secEmailID
one parent
...
abstract one sig MachineStates extends Association{}{
...
abstract one sig toStateID extends Integer{}
...
some sig processStateMachineExecutionID extends Integer{}
...
abstract one sig processQueryResponseActionID extends Integer{}
