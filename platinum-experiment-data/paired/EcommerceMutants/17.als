...
abstract one sig quantity extends Integer{}
abstract one sig CartItem extends Class{}{
attrSet = cartItemID
id=cartItemID
isAbstract = No
parent in Item
...
some sig ShippingCartItemAssociation extends Association{}{
src = ShippingCart
dst = Item
src_multiplicity = ONE
dst_multiplicity = MANY
...
abstract one sig categoryID extends Integer{}
...
abstract one sig productID extends Integer{}
...
abstract one sig availability extends Bool{}
